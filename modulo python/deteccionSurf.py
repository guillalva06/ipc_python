...
def deteccion(fot, obj):
	...
	for pun in puntoseval:
		...
		puntosSURF,descriptoresSURF = surf.detectAndCompute(grises,None)
		puntosSURF2,descriptoresSURF2 = surf.detectAndCompute(grises2,None)
		seleccionador=cv2.BFMatcher()
		ocurrencias = seleccionador.knnMatch(descriptoresSURF,descriptoresSURF2, k=2)
